...
public class VehicleMovement : MonoBehaviourPun, IPunObservable
{
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        if (stream.IsWriting)
        {
            ...
            stream.SendNext(vehicleActive);
        }
        else
        {
            // Network player, receive data
            this.vehicleActive = (bool)stream.ReceiveNext();
        }
    }
    #endregion
...
public class VehicleActivationEvent : MonoBehaviourPun
{
